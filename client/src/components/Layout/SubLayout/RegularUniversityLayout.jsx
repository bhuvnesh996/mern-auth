...
export default function RegularUniversityLayout({selectedUniversity}) {
  ...
  return (
    ...
    <div className= 'flex h-screen' >
        <div className='flex bg-indigo-300 flex-col'>
      {/* Sidebar content */}
      ...
      <nav className='h-[80px] p-4  bg-white'>
        <ul className='pt-2 flex justify-between items-center align-middle'>
          <li className='mx-4 w-[150px]'>
              <button className='bg-indigo-400 text-white w-[150px] h-[40px] cursor-pointer rounded-lg 
          ...
          <li className='mx-4'>
              <button onClick={handleReset} className='bg-indigo-400 text-white w-[150px] font-bold h-[40px] border-2 border-white-600 
