...
import { DeletePopUp } from './DeletePopUp';
  const TABLE_HEAD = ["University Name", "Vertical/Mode",  "FormID", "Fields",""];
  const TABS = [
    {
      label: "All",
      value: "all",
...
export default function AdminFormeTable({Form}) {
    ...
    <Card className="h-full w-full">
        ...
        <div className="mb-8 flex items-center justify-between gap-8">
          <div>
            ...
            <Typography color="gray" className="mt-1 font-normal">
              See information about all form
            </Typography>
          </div>
          <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
            ...
            <Button className="flex items-center gap-3" size="sm" onClick={(e)=>navigate("/admin/university/form/create") }>
      ...
      <CardBody className="overflow-scroll px-0">
        <table className="mt-4 w-full min-w-max table-auto text-left">
          ...
          <tbody>
            {  Array.isArray(Form)  ?  Form?.map(
              ({ _id,universityName ,vertical,form }, index) => {
